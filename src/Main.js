  ...
  },
  {
    ...
    horns: 1
        ...
        return (
            <div>
           <HornedBeasts
           image_url={arrayBeast[0].image_url}
           title={arrayBeast[0].title}
           description={arrayBeast[0].description}
           click={0}
           />     

<HornedBeasts
           image_url={arrayBeast[1].image_url}
           title={arrayBeast[1].title}
           description={arrayBeast[1].description}
           click={0}
           />  
           
<HornedBeasts
           image_url={arrayBeast[2].image_url}
           title={arrayBeast[2].title}
           description={arrayBeast[2].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[3].image_url}
           title={arrayBeast[3].title}
           description={arrayBeast[3].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[4].image_url}
           title={arrayBeast[4].title}
           description={arrayBeast[4].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[5].image_url}
           title={arrayBeast[5].title}
           description={arrayBeast[5].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[6].image_url}
           title={arrayBeast[6].title}
           description={arrayBeast[6].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[7].image_url}
           title={arrayBeast[7].title}
           description={arrayBeast[7].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[8].image_url}
           title={arrayBeast[8].title}
           description={arrayBeast[8].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[9].image_url}
           title={arrayBeast[9].title}
           description={arrayBeast[9].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[10].image_url}
           title={arrayBeast[10].title}
           description={arrayBeast[10].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[11].image_url}
           title={arrayBeast[11].title}
           description={arrayBeast[11].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[12].image_url}
           title={arrayBeast[12].title}
           description={arrayBeast[12].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[13].image_url}
           title={arrayBeast[13].title}
           description={arrayBeast[13].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[14].image_url}
           title={arrayBeast[14].title}
           description={arrayBeast[14].description}
           click={0}
           />  
           
           <HornedBeasts
           image_url={arrayBeast[15].image_url}
           title={arrayBeast[15].title}
           description={arrayBeast[15].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[16].image_url}
           title={arrayBeast[16].title}
           description={arrayBeast[16].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[17].image_url}
           title={arrayBeast[17].title}
           description={arrayBeast[17].description}
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[18].image_url}
           title={arrayBeast[18].title}
           description={arrayBeast[18].description}
           
           click={0}
           />  
                      
<HornedBeasts
           image_url={arrayBeast[19].image_url}
           title={arrayBeast[19].title}
           description={arrayBeast[19].description}
           click={0}
           />  
